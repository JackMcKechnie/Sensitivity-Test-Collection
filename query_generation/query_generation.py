...
def save_results(r1,r2,r3,r4,r5,ids):
    user_id = str(uuid.uuid4())
    path_name = "./query_gen_results/" + user_id + ".csv"
    results = [[user_id,ids[0]+1,r1],[user_id,ids[1]+1,r2],[user_id,ids[2]+1,r3],[user_id,ids[3]+1,r4],[user_id,ids[4]+1,r5]]
...
def query_gen():
    ...
    if request.method == 'POST':
        if "done" in request.form:
            ...
            save_results(result1,result2,result3,result4,result5,ids)
